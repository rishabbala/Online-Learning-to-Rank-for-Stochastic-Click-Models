...
if __name__ == '__main__':
    ...
    algorithms['CascadeUCB1-Attack'] = CascadeUCB1(data, data.num_arms, seed_size, attack=True)
    algorithms['BatchRank-Attack'] = BatchRank(data, data.num_arms, seed_size, iterations, attack=True)
    algorithms['TopRank-Attack'] = TopRank(data, data.num_arms, seed_size, iterations, attack=True)
